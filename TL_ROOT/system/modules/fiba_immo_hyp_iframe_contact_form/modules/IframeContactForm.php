...
class IframeContactForm extends Module
{
    ...
    protected function compile()
    {
        ...
        else
        {
            ...
            $this->Template->partner = null;
            if ($this->objPartner !== null)
            {
                $arrPartner = $this->objPartner->row();
                if ($arrPartner['partnerHiredByGender'] != '')
                {
                    $arrPartner['partnerHiredByGender'] = $arrPartner['partnerHiredByGender'] == 'female' ? 'Frau' : 'Herr';
                }
                $this->Template->partner = $arrPartner;
            }
