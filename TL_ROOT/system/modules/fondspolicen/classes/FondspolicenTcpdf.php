...
class FondstabellenPdfBase extends \TCPDF
{
    ...
    public function Header()
    {
        ...
        // Logo header left
        //$logoSRC = TL_ROOT . '/system/modules/fondspolicen/assets/fiba-logo.png';
        //$this->Image($logoSRC, 20, 10, 15, '', '', 'http://www.fiba-consulting.de', '', false, 300, '', false, false, 0);

        // Logo header right
        $logoSRC = TL_ROOT . '/system/modules/fondspolicen/assets/Fondspolicen-Analyse_Logo1.jpg';
...
class FondspolicenTcpdf extends \System
{
    ...
    public function printFondspolicen($html)
    {
        ...
        //opensanslight
        \TCPDF_FONTS::addTTFfont(TL_ROOT . '/system/modules/fondspolicen/fonts/opensans/OpenSans-Light.ttf', 'TrueTypeUnicode', '', 96);
        // opensansb
        \TCPDF_FONTS::addTTFfont(TL_ROOT . '/system/modules/fondspolicen/fonts/opensans/OpenSans-Bold.ttf', 'TrueTypeUnicode', '', 96);
        //opensanslighti
        \TCPDF_FONTS::addTTFfont(TL_ROOT . '/system/modules/fondspolicen/fonts/opensans/OpenSans-LightItalic.ttf', 'TrueTypeUnicode', '', 96);
        ...
        $html = str_replace('<span class="fa fa-check-circle"></span>', '<img src="system/modules/fondspolicen/assets/checked-symbol.png" width="9"/>', $html);
